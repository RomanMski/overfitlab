...
At $\ell = 1$ the scheme reduces to independent resampling. Every autocorrelation, every volatility cluster, every trend is gone, while the marginal distribution of returns is untouched. At large $\ell$ almost all local structure survives.
