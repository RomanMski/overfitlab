...
<section><div class="section-head"><div><span>Falsification</span><h2>Permutation null</h2></div></div><p class="note">The +1 p-value counts permuted-label fits that matched or exceeded their paired clean baseline. It tests predictive structure under this exchangeability scheme; it is not an estimate of future error.</p>{permutation_table}</section>
{errors}
...
<footer>Generated by StressFold 0.1.0 · {escape(result.created_at)}</footer>
</main></body></html>"""
