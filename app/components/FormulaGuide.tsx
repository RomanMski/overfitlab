...
const FORMULAS: FormulaDefinition[] = [
  ...
  },
  {
    ...
    unusual: "R < 0 means the loss increase exceeded D_b. R > 1 means the stressed run beat the clean run. When clean improvement is tiny, a denominator floor is active and the value should be interpreted cautiously.",
    boundary: "Retained skill is a paired, normalized response within block b. It is not a universal pass mark and depends on the reference, loss, denominator rule, and stress mechanism.",
  },
  {
    id: "monte-carlo",
  ...
  },
  {
    ...
    question: "What percentage of label-shuffled pipeline scores are no higher than the observed score?",
    ...
    equation: [
      ...
      { text: "(" },
      { text: "1", term: "correction", spoken: "plus-one correction" },
      { text: " + Σ " },
    ...
    terms: [
      {
        ...
        definition: "Corrected percentage of permutation scores no higher than the observed score.",
      },
      {
        id: "count",
        symbol: "K",
      ...
      },
      {
        ...
        definition: "Returns 1 when S_π ≤ S_obs and 0 otherwise. Its sum counts null scores no higher than observed.",
      },
      {
        id: "correction",
        symbol: "+1",
        name: "finite Monte Carlo correction",
        definition: "Includes the observed arrangement. The estimated percentage is never zero.",
      },
      {
        id: "scale",
        symbol: "100",
    ...
    example: {
      values: "K = 24; 22 shuffled refits have score ≤ the median observed score.",
      steps: [
        "P_null = 100(1 + 22) / (24 + 1)",
        "P_null = 2300 / 25",
      ],
      result: "P_null = 92.0%",
    },
    ...
    unusual: "With K = 24, the plus-one rank moves in 4 percentage-point steps. A high rank can still be invalid if exchangeability fails or a target-dependent fitting step is left outside the null refit.",
